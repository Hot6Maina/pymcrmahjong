...
class QuadrupleChow(BaseYaku):
    def __init__(self):
        super().__init__(YakuEnum.QUADRUPLE_CHOW)
    ...
    def is_satisfied(self, division: Division, agari_info: AgariInfo):
        for part1, part2, part3, part4 in combinations(division.parts, 4):
            ...
            if (
                first_number_list[0] == first_number_list[1] and
                first_number_list[1] == first_number_list[2] and
                first_number_list[2] == first_number_list[3]
            ):
                return int(True)
        return int(False)
