...
class PungOfTerminalsOrHonors(BaseYaku):
    def __init__(self):
        super().__init__(YakuEnum.PUNG_OF_TERMINALS_OR_HONORS)
    ...
    def is_satisfied(self, division: Division, agari_info: AgariInfo):
        return sum(
            ...
            and part.counts.is_containing_only(Tiles.TERMINALS_AND_HONORS)
        )
